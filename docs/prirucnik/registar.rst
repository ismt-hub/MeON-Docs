...
МеОн омогућава кориснику лаку претрагу података и брзо долажење до потребних докумената коришћењем :ref:`интерактивног наслова<navigacija>`, :ref:`листа<lista>`, :ref:`детаља<detalj>` и :ref:`навигатора<navigator>`.
